...
Isto não protege contra o usuário apagar os dados do navegador ou contra a remoção do armazenamento pelo sistema operacional. Não há promessa de acesso à página durante toda situação offline: os registros sobrevivem ao fechamento e são retomados quando o aplicativo voltar a carregar.
